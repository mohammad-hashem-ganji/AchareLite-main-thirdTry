...
namespace App.Domain.AppServices
{
    public class SubCategoryAppService : ISubCategoryAppService
    {
        ...
        public async Task<List<SubCategoryDto>> ShowListOfSubCategoriesWhitMianCategoryId(int id, CancellationToken cancellationToken) => await _subCategoryService.ShowListOfSubCategoriesWhitMianCategoryId(id, cancellationToken);
    }
}
